...
int dataPin = 51;       // 'yellow' wire
int clockPin = 52;      // 'green' wire
...
void setup() {
  ...
  color = Color(0,  62,    63); // Red
//  for(i=0; i<strip.numPixels(); i++) strip.setPixelColor(i, color);

  strip.setPixelColor(0, Color(5, 0, 0));
  strip.setPixelColor(1, Color(7, 0, 0)); 
  strip.setPixelColor(2, Color(9, 0, 0));
  strip.setPixelColor(3, Color(13, 0, 0));
  strip.setPixelColor(4, Color(15, 0, 0));
  strip.setPixelColor(5, Color(31, 0, 0));
